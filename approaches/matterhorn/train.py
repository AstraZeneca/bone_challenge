...
if __name__ == "__main__":
    ...
    parser.add_argument("--summary-path", type=str, default="/scratch/kmmg694/BoneAI/train.csv", help="Path to summary file")
    ...
    parser.add_argument('--augmented-dataset-root-dir', type=str, default="/scratch/kmmg694/BoneAI/augmented_data", help='Specify the root directory for the augmented dataset.')        
