...
def get_random_niifilename(n: int = 1, folderpath: str = '../shared/workstream-2/images_3d') -> list:
    '''
...
def get_slices_sums_normalized(folderpath: str = '../shared/workstream-2/images_3d'):
...
def window_image(x_thr_max: float, y_thr_max: float,
                 folderpath = '../shared/workstream-2/images_3d', outputpath = 'windowed_imgs'):
    '''
...
def show_slices(file_code: str = None, axs: str = 'x', n_fig: int = 5, 
                step: int = 5, folderpath: str = 'windowed_imgs', train_csv: str = 'train.csv'):
...
def center_and_crop(width: int = 320,
                    height:int = 330,
                    folderpath: str = '../shared/workstream-2/images_3d',
                    outputpath: str = 'trainset-xyarea/z-axis'):
